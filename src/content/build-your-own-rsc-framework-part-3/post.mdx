---
title: Build your own RSC Framework - Part 3/n (Suspense Enabled Full Stack Router)
...
As discussed in the previous part we will be enhancing the re-fetching and re-rendering of RSC Payload by implementing a minimal suspense enabled full stack router. Links to previous posts if you have missed:

- [Part 1](/blog/build-your-own-rsc-framework-part-1) - Server Components
- [Part 2](/blog/build-your-own-rsc-framework-part-1) - Client Components

## Full Stack File System Router

The implementation which we used previously has both the application code and framework code coupled with each other. We will separate the application code from the framework code by implementing a minimal file system router.
