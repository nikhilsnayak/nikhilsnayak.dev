...
```tsx lineNumbers filename="AutoScrollList.tsx" highlight="4,6-23,25-34"
...
```tsx lineNumbers filename="AutoScrollList.tsx" highlight="5-71"
export function AutoScrollList({ className, ...rest }) {
  return <ul ref={autoScrollListRef} className={`overflow-y-auto ${className}`} {...rest} />;
}
...
You can copy paste this component to your project from [here](https://github.com/nikhilsnayak/nikhilsnayak.dev/blob/main/src/components/auto-scroll-list.tsx)
