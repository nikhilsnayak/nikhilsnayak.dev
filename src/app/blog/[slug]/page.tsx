...
import { SeriesNavigation } from '~/features/blog/components/series-navigation';
...
export default async function BlogPage({ params }: PageProps<'/blog/[slug]'>) {
  ...
  return (
    <ViewTransition
      ...
      name='blog-post'
      default='none'
      share={{ 'series-next': 'series-next', 'series-prev': 'series-prev', default: 'none' }}
      enter={{ 'series-next': 'series-next', 'series-prev': 'series-prev', default: 'none' }}
      exit={{ 'series-next': 'series-next', 'series-prev': 'series-prev', default: 'none' }}
    >
      <section>
        <script
