      ...
      <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3'>
        {blog.map((post) => (
          <Link
            key={post.slug}
            href={`/blog/${post.slug}`}
            className='group border-border block h-full transform space-y-2 overflow-hidden rounded-lg border p-4 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl'
          >
