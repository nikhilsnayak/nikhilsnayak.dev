  ...
  return (
    <main>
      ...
      <form action={addMovie} className='mx-auto max-w-lg space-y-4 p-4'>
        ...
        <button
          type='submit'
          className='w-full rounded-md bg-indigo-600 px-4 py-2 text-white shadow-xs hover:bg-indigo-700 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
        >
          Add Movie
        </button>
      </form>
