...
```js lineNumbers filename="server.js" addition="11,12,21,25-28,30-37" deletion="20,29"
require('@babel/register')({
  ignore: [/[\\\/](dist|node_modules)[\\\/]/],
  presets: [['@babel/preset-react', { runtime: 'automatic' }]],
  plugins: ['@babel/plugin-transform-modules-commonjs'],
...
parentPort.on('message', async (request) => {
  ...
  const tree = await ReactServerDOMWebpackClient.createFromNodeStream(
...
```js lineNumbers addition="13,14,20-22,42-75" deletion="11,12,30-41"
require('@babel/register')({
  ignore: [/[\\\/](dist|node_modules)[\\\/]/],
  presets: [['@babel/preset-react', { runtime: 'automatic' }]],
  plugins: ['@babel/plugin-transform-modules-commonjs'],
