...
We've been ignoring an important aspect of the application. While async components for data fetching and SSR are great, where is React's main selling point client-side interactivity?
