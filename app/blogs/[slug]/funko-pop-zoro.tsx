  ...
  return (
    ...
    >
      <div className='relative'>
        <FunkoPopZoroSvg />
        {isVisible && (
          <div className='absolute -top-32 right-16 max-w-sm rounded-lg border border-gray-300 bg-white p-4 shadow-lg'>
            <p className='text-sm text-gray-700'>
              Hey there! Do you know where I can find my swords? Just kidding. I
              can summarize this blog for you{' '}
              <Link
                href={{
                  pathname: '/bot',
                  query: {
                    ...(blogTitle && { prompt: `Summarize ${blogTitle} blog` }),
                  },
                }}
